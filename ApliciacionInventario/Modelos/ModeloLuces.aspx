<%@ Page Language="C#" MasterPageFile="~/DemoMaster.master" AutoEventWireup="true" CodeBehind="ModeloLuces.aspx.cs" Inherits="ApliciacionInventario.Modelos.ModeloLuces" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    </asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="tituloForm">
        Luces de Emergencia<tr>
            <td width ="180px">
                <asp:Image ID="Image1" runat="server" Height="285px" 
                    ImageUrl="~/Images/Luces.png" Width="248px" />
            </td>
            <td>
                ...
                <asp:TreeView ID="TreeView1" runat="server" CssClass="labelContenido" ImageSet="Arrows">
                    ...
                    <Nodes>
                        <asp:TreeNode Text="Mantenimiento" Value="Nuevo nodo">
                            <asp:TreeNode NavigateUrl="~/Modelos/ListaLuces.aspx" Text="Lista de modelos" Value="Proveedor"></asp:TreeNode>
