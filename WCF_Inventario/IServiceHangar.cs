...
{
    // NOTA: puede usar el comando "Rename" del menú "Refactorizar" para cambiar el nombre de interfaz "IServiceHangar" en el código y en el archivo de configuración a la vez.
    [ServiceContract]
    public interface IServiceHangar
    {
        [OperationContract]
        HangarBE ConsultarHangar(Int16 id);

        [OperationContract]
        HangarBE ConsultarHangar2(Int16 id);

        [OperationContract]
        List<HangarBE> ListarHangar();

        [OperationContract]
        List<HangarBE> ListarHangar2();

        [OperationContract]
        Boolean InsertarHangar(HangarBE objHangarBE);

        [OperationContract]
        Boolean ActualizarHangar(HangarBE objHangarBE);

        [OperationContract]
        Boolean EliminarHangar(Int16 id);
    }

    [DataContract]
    [Serializable]
    public class HangarBE
    {
